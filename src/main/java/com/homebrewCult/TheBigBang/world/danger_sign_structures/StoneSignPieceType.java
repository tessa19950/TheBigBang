...
public class StoneSignPieceType extends AbstractDangerSignPieceType {
    public StoneSignPieceType(TemplateManager manager, ResourceLocation pieceIn, BlockPos pos, Rotation rotationIn, IStructurePieceType type) {
        super(manager, pieceIn, pos, rotationIn, type);
    }

    public StoneSignPieceType(TemplateManager manager, CompoundNBT nbt) {
    ...
    public Vec3i getTemplateOffset(int index) {
        switch(index) {
            case 0: case 1: return new Vec3i(-3,-4,-2);
            case 2: case 3: return new Vec3i(-2,-4,-3);
