...
public enum Quests {
	...
	Polluted("POLLUTED!", 100,
			...
			99),
	Polluted2("POLLUTED! Part 2", 1400,
			"Eliminate #kill_amount# #entity# for the Rememberer.",
			999),

	//SNAIL QUESTS
	BasicTraining("Basic Training", 30,
			...
			15),
	MaisTrainingSnail("Mai's Training", 70,
	...
	HelpHuntTheSnails("Help Hunt the Snails", 20,
	...
	MariasLetter("Maria's Letter", 100,
			...
			10, ImmutableMap.of(ModItems.LETTER, 1), QuestItems.LucasLetter),
	HelpOutYoona("Help out Yoona", 30,
			...
			30),
	MaisSecondTraining("Mai's Second Training", 10,
	...
	MayasFirstCollection("Maya's First Collection", 300,
	...
	TheOldSnail("The Old Snail", 100,
			...
			10, ImmutableMap.of(ModItems.LETTER, 1), QuestItems.SnailLegend),
	ARainbowShell("A Rainbow Shell", 30,
	...
	//OCTOPUS QUESTS
	MrsMingMingsWorry("Mrs. Ming Ming's Worry", 160,
	...
	MakingASparklingRockOctopus("Making a Sparkling Rock", 240,
	...
	KerningCitizenRequest("Kerning Citizen Request", 70,
	...
	HowToSurvive("How to Survive", 50,
			...
			10),
	BuildingANewHouseOctopus("Building a New House", 500,
	...
	TheDarkLordsTraining("The Dark Lord's Training", 120,
			...
			40),
	OctopusesAreHealthy("Octopus' are Healthy", 50,
			"Gather the necessary ingredients to make a special tonic to energize Lady Syl. Hunt some Octopuses around this sign and gather some Octopus Legs.",
			ImmutableMap.of(ModItems.OCTOPUS_LEG, 20)),
	RolyPolys6sTools("Roly-Poly 6's Tools", 120,
			...
			QuestItems.RolyPolysTools),
	OctopusAreAliens("Octopus are Aliens?", 120,
			...
			QuestItems.OctopusMail),
	VirusSampleResearchOctopus("Virus Sample Research", 120,
	...
	//MUSHROOM QUESTS
	VirusSampleResearchMushroom("Virus Sample Research", 120,
	...
	BiggsItemCollection("Biggs' Item Collection", 100,
	...
	PiaAndTheBlueMushroom("Pia and the Blue Mushroom", 50,
	...
	TheMushroomStudies("The Mushroom Studies", 100,
	...
	BuildingANewHouseMushroom("Building a New House", 300,
	...
	MushroomJuiceMixer("Mushroom Juice Mixer", 50,
	...
	MushroomSaladRecipe("Mushroom Salad Recipe", 50,
	...
	SaladIngredients("Salad Ingredients", 60,
	...
	MakingHornyMushroomPie("Making Horny Mushroom Pie", 200,
	...
	//STUMP QUESTS
	FixingBlackbullsHouse("Fixing Blackbull's House", 30,
			"Blackbull needs to make some repairs to his home in Perion, and needs you to collect some sticks and charcoal for him.",
			ImmutableMap.of(Items.STICK, 10, Items.COAL, 5)),
	MaisTrainingStump("Mai's Training", 20,
			"The highly skilled fighter Mai helps train new adventurers on Maple Island, and is rewarding experts from other worlds. Collect 3 sticks for her, to show her your combat prowess.",
			ImmutableMap.of(Items.STICK, 3)),
	ImBored("I'm Bored", 100,
			"On the rooftops of Kerning City, a young boy named Icarus is bored out of his mind. He needs you to collect sticks and slime for him, which will somehow solve his problem.",
			ImmutableMap.of(Items.STICK, 5, Items.SLIME_BALL, 5)),
	GettingArconsBlood("Getting Arcon's Blood", 150,
			"Sophia needs someone to collect items for her and Manji, including some Arcon's Blood which should be dropped by Stumps. I wonder what they're planning to do with this stuff.",
			ImmutableMap.of(Items.OAK_LEAVES, 5, ModItems.OCTOPUS_LEG, 10, ModItems.LETTER, 1), QuestItems.ArconsBlood),
	DrBettysResearchOnPlants("Dr Betty's Research on Plants", 200,
			"A request comes all the way from Ellinia. The renowned Dr Betty is researching plant-like monsters and needs someone to collect plant samples from the local Stump herd.",
			ImmutableMap.of(ModItems.LETTER, 20), QuestItems.PlantSample),
	WinstonsFossilDigUp("Winston's Fossil Dig Up", 150,
			"The archeologist Winston is looking for recruits to help him collect fossils. The rocky mountains are running out, and he'd like you to collect some items from the Stumps in your area.",
			ImmutableMap.of(Items.OAK_LEAVES, 10, Items.CHARCOAL, 5, ModItems.LETTER, 1), QuestItems.FossilReport),
	NeedHelpOnMyHomework("Need Help on my Homework", 200,
			"Wing is completely stumped by her homework. Even though she's a fairy, she really needs your help. Please send these items to Ellinia and she'll reward you handsomely.",
			ImmutableMap.of(Items.STICK, 5, Items.SLIME_BALL, 10)),
	WarriorsFirstTraining("Warrior's First Training", 150,
			"Living at the top of Perion, Dances with Balrog has sent out these requests for aspiring warriors, slay Stumps for him to prove your worth. ",
			100),
	WarriorsSecondTraining("Warrior's Second Training", 250,
			"Dances with Balrog would like you to continue your training by hunting even more Stumps this time.",
			150),
	StumpHorrorStory("Stump Horror Story", 100,
			"Ayan's had some horrible nightmares recently, about Stumps. She needs you to take them down to help her get over her fear of the creatures.",
			100),
	NeedToFindMyDaughter("Need to Find my Daugher", 120,
			"Bruce really wants to get back in touch with his daughter Ayan. He sent her a letter a while ago, but it seems to have been intercepted by a group of Stumps, please recover Bruce's letter for him.",
			ImmutableMap.of(ModItems.LETTER, 1)),
	SophiasSnack("Sophia's Snack", 750,
			"After Sophia's succesfull endaevor with Manji, she wants to make some snacks for the entire village. She needs loads of sap from the Stumps, it's considered a delicacy there after all.",
			ImmutableMap.of(ModItems.SAP_OF_ANCIENT_TREE, 20)),

	//JR YETI QUESTS
	GordonTheCraftsman("Gordon the Craftsman", 60,
	...
	OneMoreWish("One More Wish", 70,
			...
			ImmutableMap.of(ModItems.JRYETI_SKIN, 30)),
	GordonsTuition("Gordon's Tuition", 120,
	...
	JrYetiKeychain("Jr. Yeti Keychain", 120,
			...
			ImmutableMap.of(ModItems.LETTER, 1), QuestItems.JrYetiKeychain),
	YetiResearchProgress("Yeti Research Progress", 150,
			"From our results it seems Pepes have evolved from simple sea birds to overbearing jerks. Meanwhile, the Yeti are currently in the process of evolving into creatures composed entirely of hair. The relationship between Yetis and Jr. Yetis remains unclear...",
			100),
	...
	LazyLittleCalico("Lazy Little Calico", 50,
	...
	StrangeDish_EvilEye("Strange Dish", 120,
	...
	StrangeDish_CurseEye("Strange Dish", 150,
			"Tangyoon has been experimenting with a new dish recently, using an ingredient that no one has ever used before. "
					+ "He's been working with #item0#s and says that he could make something new and fresh if only you would bring him #item_amount0# #item0#s...",
			ImmutableMap.of(ModItems.CURSE_EYE_TAIL, 180)),
	StrangeDish_ColdEye("Strange Dish", 80,
			"Tangyoon has been experimenting with a new dish recently, using an ingredient that no one has ever used before. "
					+ "He's been working with #item0#s and says that he could make something new and fresh if only you would bring him #item_amount0# #item0#s...",
			ImmutableMap.of(ModItems.COLD_EYE_TAIL, 20)),
	CutthroatMannysRequest("Cutthroat Manny's Request", 200,
	...
	ZombieMushroomSignal("Zombie Mushroom Signal", 80,
	...
	TheOutbreak("The Outbreak", 200,
			...
			ImmutableMap.of(ModItems.UNDEAD_CHARM, 20, ModItems.LETTER, 1), QuestItems.VaccineRecipe),
	RowensCursedMushrooms("Rowen's Cursed Mushrooms", 150,
	...
	MysteryOfTheHospital("Mystery of the Hospital", 100,
			...
			ImmutableMap.of(ModItems.UNDEAD_CHARM, 200)),
	...
	ShawnTheExcavator("Shawn the Excavator", 100,
			...
			50),
	HowToAvoidTheStink("How to Avoid the Stink", 150,
	...
	SpiritDiviner("Spirit Diviner", 100,
			"Unleash the spirits of Undead monsters by eliminating 70 Zombie Mushrooms and sending them back to nirvana. Doing so will acquire you the title of Spirit Diviner.",
			70),
	GasMaskAlternative("Gas Mask Alternative", 300,
			...
			ImmutableMap.of(ModItems.UNDEAD_CHARM, 30, ModItems.LETTER, 1, Items.NETHER_WART, 10), QuestItems.NotBreathingPotionRecipe),
	ZombieMushroomThreat("Zombie Mushroom Threat", 150,
	...
	//GOLEM QUESTS
	DrBrucesResearch("Dr. Bruce's Research", 100,
	...
	ANewHouseForBlackbull("A New House for Blackbull", 300,
			...
			ImmutableMap.of(ModItems.STONE_GOLEM_RUBBLE, 20, Items.IRON_INGOT, 5, ModItems.LETTER, 1), QuestItems.BlackbullsDeed),
	LastMaterialForRonnie("Last Material for Ronnie", 120,
	...
	MayasLastCollection("Maya's Last Collection", 300,
	...
	EliminateTheGolems("Eliminate the Golems", 160,
	...
	TheMixedGolemThreat("The Mixed Golem Threat", 120,
			...
			60),
	TheMixedGolemMutation("The Mixed Golem Mutation", 160,
			...
			80),
	CharmsForInfo("Charms for Info", 400,
	...
	//DRAKE QUESTS
	WhatPiaHasBorrowed("What Pia has Borrowed", 400,
			...
			ImmutableMap.of(ModItems.DRAKES_SKULL, 30, Items.DIAMOND, 1, ModItems.LETTER, 1), QuestItems.AntiqueScroll),
	BuildingMoreHouses("Building more Houses", 200,
	...
	JanesChallenge("Jane's Challenge", 800,
			...
			ImmutableMap.of(ModItems.DRAKES_BLOOD, 3, ModItems.ORANGE_MUSHROOM_CAP, 1, ModItems.LETTER, 30), QuestItems.PackagedFrog),
	JanesLastExperiment("Jane's Last Experiment", 500,
	...
	AClueToTheSecretBook("A clue to the Secret Book", 220,
			...
			ImmutableMap.of(ModItems.LETTER, 1), QuestItems.LostBook),
	TransportingDrakeSkulls("Transporting Drake Skulls", 200,
			...
			ImmutableMap.of(ModItems.DRAKES_SKULL, 50)),
	FossilResearchProgress("Fossil Research Progress", 220,
			...
			ImmutableMap.of(ModItems.LETTER, 1), QuestItems.MissingReport),
	SealUpACriticalDanger("Seal up a Critical Danger", 150,
	...
	MuirhatsWorry("Muirhat's Worry", 350,
	...
	ManjisTale("Manji's Tale", 300,
			...
			ImmutableMap.of(ModItems.DRAKES_BLOOD, 1, ModItems.LETTER, 1), QuestItems.ManjisDiary),

	//YETI QUESTS
	ReawakeningTheGladius("Reawakening the Gladius", 500,
			...
			ImmutableMap.of(ModItems.PIECE_OF_ICE, 1, ModItems.LETTER, 1, Items.MAGMA_CREAM, 1), QuestItems.AncientScroll),
	SnowfieldGiant("Snowfield Giant", 80,
	...
	SonOfScadurTheHunter("Son of Scadur the Hunter", 450,
			...
			ImmutableMap.of(ModItems.YETI_HORN, 64, ModItems.LETTER, 1), QuestItems.TranslationGuide),
	BlakesBiggestFan("Blake's Biggest Fan", 70,
			...
			30),
	MarchOfTheYetiArmy("March of the Yeti Army", 120,
	...
	ASymbioticRelationship("A Symbiotic Relationship", 220,
	...
	private final QuestItems QUEST_ITEM;
	
	private Quests(String title, int expReward, String description) {
		this(title, expReward, description, 0, ImmutableMap.of(), QuestItems.None);
	}
	
	private Quests(String title, int expReward, String description, int requiredKills) {
		this(title, expReward, description, requiredKills, ImmutableMap.of(), QuestItems.None);
	}
	
	private Quests(String title, int expReward, String description, Map<Item, Integer> requiredItems) {
		this(title, expReward, description, 0, requiredItems, QuestItems.None);
	}
	
	private Quests(String title, int expReward, String description, QuestItems questItem) {
		this(title, expReward, description, 0, ImmutableMap.of(), questItem);
	}
	
	private Quests(String title, int expReward, String description, int requiredKills, Map<Item, Integer> requiredItems) {
		this(title, expReward, description, requiredKills, requiredItems, QuestItems.None);
	}
	
	private Quests(String title, int expReward, String description, int requiredKills, QuestItems questItem) {
		this(title, expReward, description, requiredKills, ImmutableMap.of(), questItem);
	}
	
	private Quests(String title, int expReward, String description, Map<Item, Integer> requiredItems, QuestItems questItem) {
		this(title, expReward, description, 0, requiredItems, questItem);
	}
	
	private Quests(String title, int expReward, String description, int requiredKills, Map<Item, Integer> requiredItems, QuestItems questItem) {
		TITLE = title;
	...
	public QuestItems getRequiredQuestItem() {
		return this.QUEST_ITEM;
	}
	
	public boolean hasQuestItem() {
		return(this.QUEST_ITEM != QuestItems.None);
	}
}
