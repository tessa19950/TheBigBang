...
public class NightshiftArmorItem extends BigBangArmorItem {
	...
	public NightshiftArmorItem(IArmorMaterial materialIn, EquipmentSlotType slot, int defaultColorIn, Properties builder) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		NightshiftArmorModel model = NightshiftArmorModel.INSTANCE;
