...
public class NightshiftArmorItem extends BigBangArmorItem {
	...
	private NightshiftArmorModel model;
	
	public NightshiftArmorItem(NightshiftArmorModel modelIn, IArmorMaterial materialIn, EquipmentSlotType slot, int defaultColorIn, Properties builder) {
