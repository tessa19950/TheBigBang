...
public class GoldwindArmorItem extends BigBangArmorItem {
	
	public GoldwindArmorItem(IArmorMaterial materialIn, EquipmentSlotType slot, int defaultColorIn, Properties builder) {
	...
	protected Set<Item> getArmorSet() {
		return new ImmutableSet.Builder<Item>().add(
				ModItems.GOLDWIND_HELMET.getItem(),
				ModItems.GOLDWIND_CHESTPLATE.getItem(),
				ModItems.GOLDWIND_LEGGINGS.getItem(),
				ModItems.GOLDWIND_BOOTS.getItem()
		).build();
	}
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		GoldwindArmorModel model = GoldwindArmorModel.INSTANCE;
