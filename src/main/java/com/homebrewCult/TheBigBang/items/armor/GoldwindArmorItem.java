...
public class GoldwindArmorItem extends BigBangArmorItem {
	...
	private GoldwindArmorModel model;
	
	public GoldwindArmorItem(GoldwindArmorModel modelIn, IArmorMaterial materialIn, EquipmentSlotType slot, int defaultColorIn, Properties builder) {
