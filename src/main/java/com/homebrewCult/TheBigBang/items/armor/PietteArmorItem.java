...
public class PietteArmorItem extends BigBangArmorItem {
	...
	private PietteArmorModel model;
	
	public PietteArmorItem(PietteArmorModel modelIn, IArmorMaterial materialIn, EquipmentSlotType slot, int defaultColorIn, Properties builder) {
