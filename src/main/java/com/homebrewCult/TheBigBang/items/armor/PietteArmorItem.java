...
public class PietteArmorItem extends BigBangArmorItem {
	
	public PietteArmorItem(IArmorMaterial materialIn, EquipmentSlotType slot, int defaultColorIn, Properties builder) {
	...
	protected Set<Item> getArmorSet() {
		return new ImmutableSet.Builder<Item>().add(
				ModItems.PIETTE_HELMET.getItem(),
				ModItems.PIETTE_CHESTPLATE.getItem(),
				ModItems.PIETTE_LEGGINGS.getItem(),
				ModItems.PIETTE_BOOTS.getItem()
		).build();
	}
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		PietteArmorModel model = PietteArmorModel.INSTANCE;
