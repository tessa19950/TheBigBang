...
public class PilferArmorItem extends BigBangArmorItem {
	...
	private PilferArmorModel model;
	
	public PilferArmorItem(PilferArmorModel modelIn, IArmorMaterial materialIn, EquipmentSlotType slot, int defaultColorIn, Properties builder) {
