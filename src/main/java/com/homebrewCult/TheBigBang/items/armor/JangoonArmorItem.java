...
public class JangoonArmorItem extends BigBangArmorItem {
	...
	private JangoonArmorModel model;
	
	public JangoonArmorItem(JangoonArmorModel modelIn, IArmorMaterial materialIn, EquipmentSlotType slot, int defaultColorIn, Properties builder) {
