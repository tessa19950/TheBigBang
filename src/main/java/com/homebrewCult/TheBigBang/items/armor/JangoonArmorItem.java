...
public class JangoonArmorItem extends BigBangArmorItem {
	...
	public JangoonArmorItem(IArmorMaterial materialIn, EquipmentSlotType slot, int defaultColorIn, Properties builder) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		JangoonArmorModel model = JangoonArmorModel.INSTANCE;
