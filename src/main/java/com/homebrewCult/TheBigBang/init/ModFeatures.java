...
public class ModFeatures {
	...
	public static final DeferredRegister<Feature<?>> FEATURES = new DeferredRegister<>(ForgeRegistries.FEATURES, TheBigBang.MODID);
	...
	public static void registerFeatures(final RegistryEvent.Register<Feature<?>> event) {
		Registry.register(Registry.STRUCTURE_PIECE, TheBigBang.MODID + ":danger_sign_plateau", DANGER_SIGN_PLATEAU_PIECE);
		Registry.register(Registry.STRUCTURE_PIECE, TheBigBang.MODID + ":danger_sign_desert", DANGER_SIGN_DESERT_PIECE);
		Registry.register(Registry.STRUCTURE_PIECE, TheBigBang.MODID + ":danger_sign_stone", DANGER_SIGN_STONE_PIECE);
		Registry.register(Registry.STRUCTURE_PIECE, TheBigBang.MODID + ":danger_sign_ice", DANGER_SIGN_ICE_PIECE);
	}
}
