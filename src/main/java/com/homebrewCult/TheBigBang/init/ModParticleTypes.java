...
import com.homebrewCult.TheBigBang.particles.ModBreakingParticle;
...
public class ModParticleTypes {	
	...
	public static void registerParticleFactories(final ParticleFactoryRegisterEvent event) {
		Minecraft.getInstance().particles.registerFactory(ITEM_BLUE_SLIME.get(), ModBreakingParticle.BlueSlimeFactory::new);
	}
}